...
namespace Kryptos.Hrms.API.Controllers
{
    ...
    public class AcademicQualificationController : ControllerBase
    {
        ...
        [HttpPost("upload")]
        public async Task<IActionResult> UploadFiles(int employeeId,int QualificationId,int SpecializationId, int UniversityId, int InstituteId, int LanguageId , DateTime YearOfPassing, string CourseOfAppraisal, string CourseType, string Status, int CreatedBy, DateTime CreatedTime, int UpdatedBy , DateTime UpdateTime,[FromForm] AcademicQualificationUploadModel model)
        {
            try
            {
